...
namespace dnlib.DotNet
{
    ...
    public sealed class MethodSig : MethodBaseSig
    {
        ...
        public MethodSig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, TypeSig argType1)
        {
            ...
            this.genParamCount = genParamCount;
            this.retType = retType;
            parameters = ThreadSafeListCreator.Create(argType1);
        }
        ...
        public MethodSig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, TypeSig argType1, TypeSig argType2, TypeSig argType3)
        {
            ...
            this.genParamCount = genParamCount;
            this.retType = retType;
            parameters = ThreadSafeListCreator.Create(argType1, argType2, argType3);
        }
        ...
        public MethodSig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, params TypeSig[] argTypes)
        {
            ...
            this.genParamCount = genParamCount;
            this.retType = retType;
            parameters = ThreadSafeListCreator.Create(argTypes);
        }
        ...
        /// <param name="retType">Return type</param>
        /// <param name="argTypes">Argument types</param>
        public MethodSig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, ThreadSafe.IList<TypeSig> argTypes)
        {
            this.callingConvention = callingConvention;
            this.genParamCount = genParamCount;
            this.retType = retType;
        ...
        public MethodSig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, ThreadSafe.IList<TypeSig> argTypes, ThreadSafe.IList<TypeSig> paramsAfterSentinel)
        {
            this.callingConvention = callingConvention;
            this.genParamCount = genParamCount;
            this.retType = retType;
    ...
    public sealed class PropertySig : MethodBaseSig
    {
        ...
        /// <param name="argTypes">Argument types</param>
        /// <param name="paramsAfterSentinel">Parameters after sentinel</param>
        internal PropertySig(CallingConvention callingConvention, uint genParamCount, TypeSig retType, ThreadSafe.IList<TypeSig> argTypes, ThreadSafe.IList<TypeSig> paramsAfterSentinel)
        {
            this.callingConvention = callingConvention;
            this.genParamCount = genParamCount;
            this.retType = retType;
    ...
    public sealed class LocalSig : CallingConventionSig
    {
        ...
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.Create(local1);
        }
        ...
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.Create(local1, local2);
        }
        ...
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.Create(local1, local2, local3);
        }
        ...
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.Create(locals);
        }
        ...
        /// </summary>
        /// <param name="locals">All locals</param>
        public LocalSig(ThreadSafe.IList<TypeSig> locals)
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.Create<TypeSig>(locals);
        }
        ...
        internal LocalSig(ThreadSafe.IList<TypeSig> locals, bool dummy)
        {
            callingConvention = CallingConvention.LocalSig;
            Locals = ThreadSafeListCreator.MakeThreadSafe(locals);
        }
    ...
    public sealed class GenericInstMethodSig : CallingConventionSig
    {
        ...
        {
            this.callingConvention = callingConvention;
            GenericArguments = ThreadSafeListCreator.Create<TypeSig>((int) size);
        }
        ...
        {
            callingConvention = CallingConvention.GenericInst;
            GenericArguments = ThreadSafeListCreator.Create(arg1);
        }
        ...
        {
            callingConvention = CallingConvention.GenericInst;
            GenericArguments = ThreadSafeListCreator.Create(arg1, arg2);
        }
        ...
        {
            callingConvention = CallingConvention.GenericInst;
            GenericArguments = ThreadSafeListCreator.Create(arg1, arg2, arg3);
        }
        ...
        {
            callingConvention = CallingConvention.GenericInst;
            GenericArguments = ThreadSafeListCreator.Create(args);
        }
        ...
        /// </summary>
        /// <param name="args">Generic args</param>
        public GenericInstMethodSig(ThreadSafe.IList<TypeSig> args)
        {
            callingConvention = CallingConvention.GenericInst;
            GenericArguments = ThreadSafeListCreator.Create<TypeSig>(args);
        }
    ...
    public static partial class Extensions
    {
        ...
        public static ThreadSafe.IList<TypeSig> GetParams(this MethodBaseSig sig)
        {
        ...
        public static ThreadSafe.IList<TypeSig> GetParamsAfterSentinel(this MethodBaseSig sig)
        {
        ...
        public static ThreadSafe.IList<TypeSig> GetLocals(this LocalSig sig)
        {
        ...
        public static ThreadSafe.IList<TypeSig> GetGenericArguments(this GenericInstMethodSig sig)
        {
        ...
        /// <param name="sig">this</param>
        /// <returns>
        ///     The type's <see cref="CallingConventionSig.IsDefault" /> property or
        ///     <c>false</c> if input is<c>null</c>
        /// </returns>
