...
namespace dnlib.DotNet
{
    ...
    public struct Importer
    {
        ...
        private IMethod ImportInternal(MethodBase methodBase, bool forceFixSignature)
        {
            ...
            var isMethodSpec = methodBase.IsGenericButNotGenericMethodDefinition();
            if(isMethodSpec)
            {
            ...
            else
            {
                ...
                if(methodBase.DeclaringType == null) parent = GetModuleParent(methodBase.Module);
                else
        ...
        private IMemberRefParent GetModuleParent(Module module2)
        {
            ...
            var modAsm = module.Assembly;
            var isSameAssembly = modAsm == null ||
        ...
        public IField Import(FieldInfo fieldInfo, bool forceFixSignature)
        {
            ...
            IMemberRefParent parent;
            if(fieldInfo.DeclaringType == null) parent = GetModuleParent(fieldInfo.Module);
            else
        ...
        public TypeSig Import(TypeSig type)
        {
            ...
            switch(type.ElementType)
            {
                ...
                case ElementType.ValueType:
                    result = CreateClassOrValueType((type as ClassOrValueTypeSig).TypeDefOrRef, true);
                    break;
                case ElementType.Class:
                    result = CreateClassOrValueType((type as ClassOrValueTypeSig).TypeDefOrRef, false);
                    break;
