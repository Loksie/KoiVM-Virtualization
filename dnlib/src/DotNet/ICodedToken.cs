...
namespace dnlib.DotNet
{
    ...
    public interface IAssembly : IFullName
    {
        ...
        /// </summary>
        AssemblyAttributes ProcessorArchitecture
        {
            get;
            set;
        }
        ...
        ///     Gets/sets the processor architecture
        /// </summary>
        AssemblyAttributes ProcessorArchitectureFull
        {
            get;
            set;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureNone
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureMSIL
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureX86
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureIA64
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureX64
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureARM
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureNoPlatform
        {
            get;
        }
        ...
        /// </summary>
        bool IsProcessorArchitectureSpecified
        {
            get;
            set;
        }
        ...
        /// </summary>
        bool DisableJITcompileOptimizer
        {
            get;
            set;
        }
        ...
        /// </summary>
        AssemblyAttributes ContentType
        {
            get;
            set;
        }
        ...
        /// </summary>
        bool IsContentTypeWindowsRuntime
        {
            get;
        }
    }
    ...
    public static partial class Extensions
    {
        ...
        /// <returns>
        ///     A <see cref="TypeSig" /> instance or <c>null</c> if <paramref name="type" />
        ///     is invalid
        /// </returns>
        ...
        /// </summary>
        /// <param name="type">The type</param>
        /// <param name="checkValueType">
        ///     <c>true</c> if we should try to figure out whether
        ///     <paramref name="type" /> is a <see cref="ValueType" />
        /// </param>
        /// <returns>
        ///     A <see cref="TypeSig" /> instance or <c>null</c> if <paramref name="type" />
        ///     is invalid
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="TypeDefOrRefSig" /> or <c>null</c> if it's not a
        ///     <see cref="TypeDefOrRefSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="ClassOrValueTypeSig" /> or <c>null</c> if it's not a
        ///     <see cref="ClassOrValueTypeSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="ValueTypeSig" /> or <c>null</c> if it's not a
        ///     <see cref="ValueTypeSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="ClassSig" /> or <c>null</c> if it's not a
        ///     <see cref="ClassSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="GenericSig" /> or <c>null</c> if it's not a
        ///     <see cref="GenericSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="GenericVar" /> or <c>null</c> if it's not a
        ///     <see cref="GenericVar" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="GenericMVar" /> or <c>null</c> if it's not a
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="GenericInstSig" /> or <c>null</c> if it's not a
        ///     <see cref="GenericInstSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="PtrSig" /> or <c>null</c> if it's not a
        ///     <see cref="PtrSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="ByRefSig" /> or <c>null</c> if it's not a
        ///     <see cref="ByRefSig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="ArraySig" /> or <c>null</c> if it's not a
        ///     <see cref="ArraySig" />
        /// </returns>
        ...
        /// <param name="type">The type</param>
        /// <returns>
        ///     A <see cref="SZArraySig" /> or <c>null</c> if it's not a
        ///     <see cref="SZArraySig" />
        /// </returns>
        ...
        /// <param name="tdr">The type</param>
        /// <returns>
        ///     The base type or <c>null</c> if there's no base type, or if
        ///     we couldn't resolve a <see cref="TypeRef" />
        /// </returns>
        ...
        /// </summary>
        /// <param name="tdr">The type</param>
        /// <param name="throwOnResolveFailure">
        ///     <c>true</c> if we should throw if we can't
        ///     resolve a <see cref="TypeRef" />. <c>false</c> if we should ignore the error and
        ///     just return <c>null</c>.
        /// </param>
        /// <returns>
        ///     The base type or <c>null</c> if there's no base type, or if
        ...
        /// <returns>
        ///     A <see cref="TypeDef" /> or <c>null</c> if input was <c>null</c> or if we
        ...
        /// <returns>
        ///     The <see cref="FieldDef" /> or <c>null</c> if <paramref name="field" /> is
        ...
        /// <returns>
        ///     The <see cref="MethodDef" /> or <c>null</c> if <paramref name="method" /> is
    ...
    public interface IHasDeclSecurity : ICodedToken, IHasCustomAttribute, IFullName
    {
        ...
        /// </summary>
        ThreadSafe.IList<DeclSecurity> DeclSecurities
        {
            get;
        }
    ...
    public interface ITypeOrMethodDef : ICodedToken, IHasCustomAttribute, IHasDeclSecurity, IMemberRefParent, IFullName, IMemberRef, IGenericParameterProvider
    {
        ...
        /// </summary>
        ThreadSafe.IList<GenericParam> GenericParameters
        {
            get;
        }
