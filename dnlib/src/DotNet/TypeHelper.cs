...
namespace dnlib.DotNet
{
    ...
    internal struct TypeHelper
    {
        ...
        internal static bool ContainsGenericParameter(MemberRef mr)
        {
            ...
            if(md != null)
                return ContainsGenericParameter(md.Signature);
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="callConv" /> contains a <see cref="GenericVar" />
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="methodSig" /> contains a <see cref="GenericVar" />
        ///     or a <see cref="GenericMVar" />.
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="localSig" /> contains a <see cref="GenericVar" />
        ///     or a <see cref="GenericMVar" />.
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="gim" /> contains a <see cref="GenericVar" />
        ///     or a <see cref="GenericMVar" />.
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="type" /> contains a <see cref="GenericVar" /> or a
        ///     <see cref="GenericMVar" />.
        /// </returns>
        ...
        private bool ContainsGenericParameterInternal(TypeSpec type)
        {
            ...
            var res = ContainsGenericParameterInternal(type.TypeSig);
        ...
        private bool ContainsGenericParameterInternal(FieldSig fs)
        {
            ...
            var res = ContainsGenericParameterInternal(fs.Type);
        ...
        private bool ContainsGenericParameterInternal(MethodBaseSig mbs)
        {
            ...
            var res = ContainsGenericParameterInternal(mbs.RetType) ||
        ...
        private bool ContainsGenericParameterInternal(LocalSig ls)
        {
            ...
            var res = ContainsGenericParameter(ls.Locals);
        ...
        private bool ContainsGenericParameterInternal(GenericInstMethodSig gim)
        {
            ...
            var res = ContainsGenericParameter(gim.GenericArguments);
