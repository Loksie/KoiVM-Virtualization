...
namespace dnlib.DotNet
{
    ...
    public abstract class EventDef : IHasCustomAttribute, IHasSemantic, IFullName, IMemberDef
    {
        ...
        /// <summary>
        ///     Reset <see cref="AddMethod" />, <see cref="InvokeMethod" />, <see cref="RemoveMethod" />,
        ///     <see cref="OtherMethods" />
        /// </summary>
    ...
    internal sealed class EventDefMD : EventDef, IMDTokenProviderMD
    {
        ...
        public EventDefMD(ModuleDefMD readerModule, uint rid)
        {
            ...
            uint name;
            var eventType = readerModule.TablesStream.ReadEventRow(OrigRid, out attributes, out name);
