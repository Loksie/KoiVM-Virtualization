...
namespace dnlib.DotNet.MD
{
    ...
    internal sealed class DotNetTableSizes
    {
        ...
        public TableInfo[] CreateTables(byte majorVersion, byte minorVersion, out int maxPresentTables)
        {
            ...
            tableInfos[(int) Table.Module] = new TableInfo(Table.Module, "Module", new[]
            {
            ...
            tableInfos[(int) Table.TypeRef] = new TableInfo(Table.TypeRef, "TypeRef", new[]
            {
                new ColumnInfo(0, "ResolutionScope", ColumnSize.ResolutionScope),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "Namespace", ColumnSize.Strings)
            });
            tableInfos[(int) Table.TypeDef] = new TableInfo(Table.TypeDef, "TypeDef", new[]
            {
            ...
            tableInfos[(int) Table.FieldPtr] = new TableInfo(Table.FieldPtr, "FieldPtr", new[]
            {
                new ColumnInfo(0, "Field", ColumnSize.Field)
            });
            tableInfos[(int) Table.Field] = new TableInfo(Table.Field, "Field", new[]
            {
                new ColumnInfo(0, "Flags", ColumnSize.UInt16),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "Signature", ColumnSize.Blob)
            });
            tableInfos[(int) Table.MethodPtr] = new TableInfo(Table.MethodPtr, "MethodPtr", new[]
            {
                new ColumnInfo(0, "Method", ColumnSize.Method)
            });
            tableInfos[(int) Table.Method] = new TableInfo(Table.Method, "Method", new[]
            {
            ...
            tableInfos[(int) Table.ParamPtr] = new TableInfo(Table.ParamPtr, "ParamPtr", new[]
            {
                new ColumnInfo(0, "Param", ColumnSize.Param)
            });
            tableInfos[(int) Table.Param] = new TableInfo(Table.Param, "Param", new[]
            {
                new ColumnInfo(0, "Flags", ColumnSize.UInt16),
                new ColumnInfo(1, "Sequence", ColumnSize.UInt16),
                new ColumnInfo(2, "Name", ColumnSize.Strings)
            });
            tableInfos[(int) Table.InterfaceImpl] = new TableInfo(Table.InterfaceImpl, "InterfaceImpl", new[]
            {
                new ColumnInfo(0, "Class", ColumnSize.TypeDef),
                new ColumnInfo(1, "Interface", ColumnSize.TypeDefOrRef)
            });
            tableInfos[(int) Table.MemberRef] = new TableInfo(Table.MemberRef, "MemberRef", new[]
            {
                new ColumnInfo(0, "Class", ColumnSize.MemberRefParent),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "Signature", ColumnSize.Blob)
            });
            tableInfos[(int) Table.Constant] = new TableInfo(Table.Constant, "Constant", new[]
            {
            ...
            tableInfos[(int) Table.CustomAttribute] = new TableInfo(Table.CustomAttribute, "CustomAttribute", new[]
            {
                new ColumnInfo(0, "Parent", ColumnSize.HasCustomAttribute),
                new ColumnInfo(1, "Type", ColumnSize.CustomAttributeType),
                new ColumnInfo(2, "Value", ColumnSize.Blob)
            });
            tableInfos[(int) Table.FieldMarshal] = new TableInfo(Table.FieldMarshal, "FieldMarshal", new[]
            {
                new ColumnInfo(0, "Parent", ColumnSize.HasFieldMarshal),
                new ColumnInfo(1, "NativeType", ColumnSize.Blob)
            });
            tableInfos[(int) Table.DeclSecurity] = new TableInfo(Table.DeclSecurity, "DeclSecurity", new[]
            {
            ...
            tableInfos[(int) Table.ClassLayout] = new TableInfo(Table.ClassLayout, "ClassLayout", new[]
            {
            ...
            tableInfos[(int) Table.FieldLayout] = new TableInfo(Table.FieldLayout, "FieldLayout", new[]
            {
                new ColumnInfo(0, "OffSet", ColumnSize.UInt32),
                new ColumnInfo(1, "Field", ColumnSize.Field)
            });
            tableInfos[(int) Table.StandAloneSig] = new TableInfo(Table.StandAloneSig, "StandAloneSig", new[]
            {
                new ColumnInfo(0, "Signature", ColumnSize.Blob)
            });
            tableInfos[(int) Table.EventMap] = new TableInfo(Table.EventMap, "EventMap", new[]
            {
                new ColumnInfo(0, "Parent", ColumnSize.TypeDef),
                new ColumnInfo(1, "EventList", ColumnSize.Event)
            });
            tableInfos[(int) Table.EventPtr] = new TableInfo(Table.EventPtr, "EventPtr", new[]
            {
                new ColumnInfo(0, "Event", ColumnSize.Event)
            });
            tableInfos[(int) Table.Event] = new TableInfo(Table.Event, "Event", new[]
            {
                new ColumnInfo(0, "EventFlags", ColumnSize.UInt16),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "EventType", ColumnSize.TypeDefOrRef)
            });
            tableInfos[(int) Table.PropertyMap] = new TableInfo(Table.PropertyMap, "PropertyMap", new[]
            {
                new ColumnInfo(0, "Parent", ColumnSize.TypeDef),
                new ColumnInfo(1, "PropertyList", ColumnSize.Property)
            });
            tableInfos[(int) Table.PropertyPtr] = new TableInfo(Table.PropertyPtr, "PropertyPtr", new[]
            {
                new ColumnInfo(0, "Property", ColumnSize.Property)
            });
            tableInfos[(int) Table.Property] = new TableInfo(Table.Property, "Property", new[]
            {
                new ColumnInfo(0, "PropFlags", ColumnSize.UInt16),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "Type", ColumnSize.Blob)
            });
            tableInfos[(int) Table.MethodSemantics] = new TableInfo(Table.MethodSemantics, "MethodSemantics", new[]
            {
            ...
            tableInfos[(int) Table.MethodImpl] = new TableInfo(Table.MethodImpl, "MethodImpl", new[]
            {
                new ColumnInfo(0, "Class", ColumnSize.TypeDef),
                new ColumnInfo(1, "MethodBody", ColumnSize.MethodDefOrRef),
                new ColumnInfo(2, "MethodDeclaration", ColumnSize.MethodDefOrRef)
            });
            tableInfos[(int) Table.ModuleRef] = new TableInfo(Table.ModuleRef, "ModuleRef", new[]
            {
                new ColumnInfo(0, "Name", ColumnSize.Strings)
            });
            tableInfos[(int) Table.TypeSpec] = new TableInfo(Table.TypeSpec, "TypeSpec", new[]
            {
                new ColumnInfo(0, "Signature", ColumnSize.Blob)
            });
            tableInfos[(int) Table.ImplMap] = new TableInfo(Table.ImplMap, "ImplMap", new[]
            {
            ...
            tableInfos[(int) Table.FieldRVA] = new TableInfo(Table.FieldRVA, "FieldRVA", new[]
            {
                new ColumnInfo(0, "RVA", ColumnSize.UInt32),
                new ColumnInfo(1, "Field", ColumnSize.Field)
            });
            tableInfos[(int) Table.ENCLog] = new TableInfo(Table.ENCLog, "ENCLog", new[]
            {
                new ColumnInfo(0, "Token", ColumnSize.UInt32),
                new ColumnInfo(1, "FuncCode", ColumnSize.UInt32)
            });
            tableInfos[(int) Table.ENCMap] = new TableInfo(Table.ENCMap, "ENCMap", new[]
            {
                new ColumnInfo(0, "Token", ColumnSize.UInt32)
            });
            tableInfos[(int) Table.Assembly] = new TableInfo(Table.Assembly, "Assembly", new[]
            {
            ...
            tableInfos[(int) Table.AssemblyProcessor] = new TableInfo(Table.AssemblyProcessor, "AssemblyProcessor", new[]
            {
                new ColumnInfo(0, "Processor", ColumnSize.UInt32)
            });
            tableInfos[(int) Table.AssemblyOS] = new TableInfo(Table.AssemblyOS, "AssemblyOS", new[]
            {
            ...
            tableInfos[(int) Table.AssemblyRef] = new TableInfo(Table.AssemblyRef, "AssemblyRef", new[]
            {
            ...
            tableInfos[(int) Table.AssemblyRefProcessor] = new TableInfo(Table.AssemblyRefProcessor, "AssemblyRefProcessor", new[]
            {
                new ColumnInfo(0, "Processor", ColumnSize.UInt32),
                new ColumnInfo(1, "AssemblyRef", ColumnSize.AssemblyRef)
            });
            tableInfos[(int) Table.AssemblyRefOS] = new TableInfo(Table.AssemblyRefOS, "AssemblyRefOS", new[]
            {
                new ColumnInfo(0, "OSPlatformId", ColumnSize.UInt32),
                new ColumnInfo(1, "OSMajorVersion", ColumnSize.UInt32),
                new ColumnInfo(2, "OSMinorVersion", ColumnSize.UInt32),
            ...
            tableInfos[(int) Table.File] = new TableInfo(Table.File, "File", new[]
            {
                new ColumnInfo(0, "Flags", ColumnSize.UInt32),
                new ColumnInfo(1, "Name", ColumnSize.Strings),
                new ColumnInfo(2, "HashValue", ColumnSize.Blob)
            });
            tableInfos[(int) Table.ExportedType] = new TableInfo(Table.ExportedType, "ExportedType", new[]
            {
                new ColumnInfo(0, "Flags", ColumnSize.UInt32),
            ...
            tableInfos[(int) Table.ManifestResource] = new TableInfo(Table.ManifestResource, "ManifestResource", new[]
            {
                new ColumnInfo(0, "Offset", ColumnSize.UInt32),
            ...
            tableInfos[(int) Table.NestedClass] = new TableInfo(Table.NestedClass, "NestedClass", new[]
            {
                new ColumnInfo(0, "NestedClass", ColumnSize.TypeDef),
                new ColumnInfo(1, "EnclosingClass", ColumnSize.TypeDef)
            });
            if(majorVersion == 1 && minorVersion == 1)
                tableInfos[(int) Table.GenericParam] = new TableInfo(Table.GenericParam, "GenericParam", new[]
                {
            ...
            tableInfos[(int) Table.MethodSpec] = new TableInfo(Table.MethodSpec, "MethodSpec", new[]
            {
                new ColumnInfo(0, "Method", ColumnSize.MethodDefOrRef),
                new ColumnInfo(1, "Instantiation", ColumnSize.Blob)
            });
            tableInfos[(int) Table.GenericParamConstraint] = new TableInfo(Table.GenericParamConstraint, "GenericParamConstraint", new[]
            {
