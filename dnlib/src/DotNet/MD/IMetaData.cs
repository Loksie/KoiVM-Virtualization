...
namespace dnlib.DotNet.MD
{
    ...
    public interface IMetaData : IDisposable
    {
        ...
        ///     Gets all streams
        /// </summary>
        ThreadSafe.IList<DotNetStream> AllStreams
        {
            get;
        }
        ...
        /// <param name="typeDefRid">Owner <c>TypeDef</c> rid</param>
        /// <returns>
        ///     The <c>ClassLayout</c> rid or 0 if <paramref name="typeDefRid" /> is invalid
        ///     or if it has no row in the <c>ClassLayout</c> table.
        /// </returns>
        ...
        /// <returns>
        ///     The <c>FieldLayout</c> rid or 0 if <paramref name="fieldRid" /> is invalid
        ///     or if it has no row in the <c>FieldLayout</c> table.
        /// </returns>
        ...
        /// <param name="rid">Owner rid</param>
        /// <returns>
        ///     The <c>FieldMarshal</c> rid or 0 if <paramref name="rid" /> is invalid
        ///     or if it has no row in the <c>FieldMarshal</c> table.
        /// </returns>
        ...
        /// <param name="fieldRid">Owner <c>Field</c> rid</param>
        /// <returns>
        ///     The <c>FieldRVA</c> rid or 0 if <paramref name="fieldRid" /> is invalid
        ///     or if it has no row in the <c>FieldRVA</c> table.
        /// </returns>
        ...
        /// <param name="rid">Owner rid</param>
        /// <returns>
        ///     The <c>ImplMap</c> rid or 0 if <paramref name="rid" /> is invalid
        ///     or if it has no row in the <c>ImplMap</c> table.
        /// </returns>
        ...
        /// <param name="typeDefRid">Owner <c>TypeDef</c> rid</param>
        /// <returns>
        ///     The <c>NestedClass</c> rid or 0 if <paramref name="typeDefRid" /> is invalid
        ///     or if it has no row in the <c>NestedClass</c> table.
        /// </returns>
        ...
        /// <param name="typeDefRid">Owner <c>TypeDef</c> rid</param>
        /// <returns>
        ///     The <c>EventMap</c> rid or 0 if <paramref name="typeDefRid" /> is invalid
        ///     or if it has no row in the <c>EventMap</c> table.
        /// </returns>
        ...
        /// <param name="typeDefRid">Owner <c>TypeDef</c> rid</param>
        /// <returns>
        ///     The <c>PropertyMap</c> rid or 0 if <paramref name="typeDefRid" /> is invalid
        ///     or if it has no row in the <c>PropertyMap</c> table.
        /// </returns>
        ...
        /// <param name="rid">Owner rid</param>
        /// <returns>
        ///     The <c>Constant</c> rid or 0 if <paramref name="rid" /> is invalid
        ///     or if it has no row in the <c>Constant</c> table.
        /// </returns>
        ...
        /// <returns>
        ///     The owner <c>TypeDef</c> rid or 0 if <paramref name="fieldRid" /> is invalid
        ...
        /// <returns>
        ///     The owner <c>TypeDef</c> rid or 0 if <paramref name="methodRid" /> is invalid
        ///     or if it has no owner.
        /// </returns>
        ...
        /// <returns>
        ///     The owner <c>TypeDef</c> rid or 0 if <paramref name="eventRid" /> is invalid
        ///     or if it has no owner.
        /// </returns>
        ...
        /// <returns>
        ///     The owner <c>TypeDef</c> rid or 0 if <paramref name="propertyRid" /> is invalid
        ///     or if it has no owner.
        /// </returns>
        ...
        /// <returns>
        ///     The owner <c>TypeOrMethodDef</c> rid or 0 if <paramref name="gpRid" /> is
        ...
        /// <returns>
        ///     The owner <c>GenericParam</c> rid or 0 if <paramref name="gpcRid" /> is
        ///     invalid or if it has no owner.
        /// </returns>
        ...
        /// <returns>
        ///     The owner <c>Method</c> rid or 0 if <paramref name="paramRid" /> is invalid
        ///     or if it has no owner.
        /// </returns>
