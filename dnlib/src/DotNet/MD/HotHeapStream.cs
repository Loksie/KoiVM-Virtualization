...
namespace dnlib.DotNet.MD
{
    ...
    internal abstract class HotHeapStream : IDisposable
    {
        ...
        /// </summary>
        /// <param name="originalHeapOffset">
        ///     Offset in the original heap. If it's the #GUID heap, it should
        ///     be <c>(index - 1) * 16</c>
        /// </param>
        ...
        protected uint BinarySearch(uint originalHeapOffset)
        {
            ...
            {
                var index = (lo + hi) / 2;
                var val = reader.ReadUInt32At(posRids + index * 4);
    ...
    internal sealed class HotHeapStreamCLR20 : HotHeapStream
    {
        ...
        public override void Initialize(long mask)
        {
            try
            {
                ...
                var ridsOffset = reader.ReadUInt32();
        ...
        protected override bool GetBlobOffset(uint originalHeapOffset, out long dataOffset)
        {
            ...
            var index = BinarySearch(originalHeapOffset);
