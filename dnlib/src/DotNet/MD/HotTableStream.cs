...
namespace dnlib.DotNet.MD
{
    ...
    internal abstract class HotTableStream : IDisposable
    {
        ...
        ///     Offset in <paramref name="fullStream" /> of start of the
        ///     hot table directory header
        /// </param>
        ...
        /// <returns>
        ///     Returns <c>0</c> if <paramref name="displ" /> is <c>0</c>, else returns
        ///     the sum of <paramref name="baseOffset" /> and <paramref name="displ" /> masked
        ///     by <paramref name="mask" />
        /// </returns>
    ...
    internal sealed class HotTableStreamCLR20 : HotTableStream
    {
        ...
        public override void Initialize(long mask)
        {
            ...
            for(var i = 0; i < tableHeaders.Length; i++)
            {
                ...
                var headerOffs = fullStream.ReadInt32();
                if(headerOffs == 0)
                    continue;
        ...
        protected override bool GetRowOffset(MDTable table, uint rid, out long offset)
        {
            ...
            var highBits = (byte) (rid >> header.shift);
            while(index < stop)
            {
