...
namespace dnlib.DotNet
{
    ...
    public sealed class ModuleDefMD : ModuleDefMD2, IInstructionOperandResolver, ISignatureReaderHelper
    {
        ...
        {
            return Load(MetaDataCreator.Load(addr), null);
        }
        ...
        {
            return Load(MetaDataCreator.Load(peImage), null);
        }
        ...
        /// </summary>
        /// <remarks>
        ///     This will read all bytes from the stream and call <see cref="Load(byte[],ModuleContext)" />.
        ///     It's better to use one of the other Load() methods.
        /// </remarks>
        /// <param name="stream">The stream (owned by caller)</param>
        /// <param name="context">Module context or <c>null</c></param>
        ...
        /// <returns>
        ///     A new <see cref="CallingConventionSig" /> instance or <c>null</c> if
        ///     <paramref name="sig" /> is invalid.
        /// </returns>
        ...
        /// <param name="sig">#Blob stream offset of signature</param>
        /// <returns>
        ///     A new <see cref="TypeSig" /> instance or <c>null</c> if
        ///     <paramref name="sig" /> is invalid.
        /// </returns>
        ...
        ///     here, else this will be <c>null</c>
        /// </param>
        /// <returns>
        ///     A new <see cref="TypeSig" /> instance or <c>null</c> if
        ///     <paramref name="sig" /> is invalid.
        ...
        /// <param name="gpContext">Generic parameter context</param>
        /// <returns>
        ///     A new <see cref="MarshalType" /> instance or <c>null</c> if there's no field
        ...
        /// <returns>
        ///     A new <see cref="CilBody" /> instance. It's empty if RVA is invalid (eg. 0 or
        ...
        /// <returns>
        ///     A new <see cref="ModuleDefMD" /> instance or <c>null</c> if <paramref name="fileRid" />
        ...
        private void InitializeModuleList()
        {
            if(moduleRidList != null)
                return;
            var rows = TablesStream.FileTable.Rows;
        ...
        private IImageStream CreateResourceStream(uint offset)
        {
            ...
            try
            {
                ...
                var length = fs.ReadUInt32(); // Could throw
        ...
        /// <returns>
        ///     A new <see cref="CustomAttribute" /> instance or <c>null</c> if
        ///     <paramref name="caRid" /> is invalid
        /// </returns>
        ...
        /// <returns>
        ///     All the data or <c>null</c> if <paramref name="rva" /> or <paramref name="size" />
        ///     is invalid
        /// </returns>
