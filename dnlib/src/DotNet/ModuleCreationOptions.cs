...
namespace dnlib.DotNet
{
    ...
    public sealed class ModuleCreationOptions
    {
        ...
        /// </summary>
        public CreateSymbolReaderDelegate CreateSymbolReader
        {
            get;
            set;
        }
        ...
        /// </summary>
        public PdbImplType PdbImplementation
        {
            get;
            set;
        }
        ...
        /// </summary>
        public bool TryToLoadPdbFromDisk
        {
            get;
            set;
        }
    ...
    /// <returns>
    ///     A <see cref="ISymbolReader" /> instance for (and now owned by)
    ///     <paramref name="module" /> or <c>null</c>.
    /// </returns>
