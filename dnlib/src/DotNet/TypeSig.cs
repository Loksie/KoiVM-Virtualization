...
namespace dnlib.DotNet
{
    ...
    public abstract class TypeDefOrRefSig : LeafSig
    {
        ...
        ///     A <see cref="TypeRef" />, <see cref="TypeDef" /> or
        ///     a <see cref="TypeSpec" />
        /// </param>
    ...
    public sealed class CorLibTypeSig : TypeDefOrRefSig
    {
        ...
        /// </summary>
        /// <param name="corType">
        ///     The type which must be a <see cref="TypeRef" /> or a
        ///     <see cref="TypeDef" />. <see cref="TypeSpec" /> and <c>null</c> are not allowed.
        /// </param>
    ...
    public sealed class GenericInstSig : LeafSig
    {
        ...
        {
            GenericType = genericType;
            GenericArguments = ThreadSafeListCreator.Create<TypeSig>((int) genArgCount);
        }
        ...
        {
            GenericType = genericType;
            GenericArguments = ThreadSafeListCreator.Create(genArg1);
        }
        ...
        {
            GenericType = genericType;
            GenericArguments = ThreadSafeListCreator.Create(genArg1, genArg2);
        }
    ...
    public sealed class ArraySig : ArraySigBase
    {
        ...
        /// <param name="sizes">Sizes list. <c>This instance will be the owner of this list.</c></param>
        /// <param name="lowerBounds">Lower bounds list. <c>This instance will be the owner of this list.</c></param>
        internal ArraySig(TypeSig arrayType, uint rank, ThreadSafe.IList<uint> sizes, ThreadSafe.IList<int> lowerBounds)
            : base(arrayType)
        {
            this.rank = rank;
            Sizes = ThreadSafeListCreator.MakeThreadSafe(sizes);
            LowerBounds = ThreadSafeListCreator.MakeThreadSafe(lowerBounds);
        }
