...
namespace dnlib.DotNet
{
    ...
    public abstract class ModuleDef : IHasCustomAttribute, IResolutionScope, IDisposable, IListListener<TypeDef>, IModule, ITypeDefFinder, IDnlibDef, ITokenResolver
    {
        ...
        /// <returns>
        ///     The imported field or <c>null</c> if <paramref name="fieldInfo" /> is invalid
        ...
        /// <returns>
        ///     The imported method or <c>null</c> if <paramref name="methodBase" /> is invalid
        ...
        /// <param name="isReflectionName">
        ///     <c>true</c> if it's a reflection name, and nested
        ///     type names are separated by a <c>+</c> character. If <c>false</c>, nested type names
        ///     are separated by a <c>/</c> character.
        /// </param>
        ...
        /// </summary>
        public ThreadSafe.IEnumerable<AssemblyRef> GetAssemblyRefs()
        {
            for(uint rid = 1;; rid++)
            {
        ...
        /// </summary>
        public ThreadSafe.IEnumerable<ModuleRef> GetModuleRefs()
        {
            for(uint rid = 1;; rid++)
            {
        ...
        /// </summary>
        public ThreadSafe.IEnumerable<MemberRef> GetMemberRefs()
        {
        ...
        /// </summary>
        /// <param name="gpContext">Generic parameter context</param>
        public ThreadSafe.IEnumerable<MemberRef> GetMemberRefs(GenericParamContext gpContext)
        {
            for(uint rid = 1;; rid++)
            {
        ...
        /// </summary>
        public ThreadSafe.IEnumerable<TypeRef> GetTypeRefs()
        {
            for(uint rid = 1;; rid++)
            {
        ...
        /// <returns>
        ///     The found <see cref="AssemblyRef" /> or <c>null</c> if there's no such
        ///     assembly reference.
        /// </returns>
    ...
    public class ModuleDefMD2 : ModuleDef, IMDTokenProviderMD
    {
        ...
        protected void InitializeFromRawRow()
        {
            ...
            var encBaseId = readerModule.TablesStream.ReadModuleRow(OrigRid, out generation, out name, out mvid, out encId);
