...
namespace dnlib.DotNet
{
    ...
    public interface IMethodDecrypter
    {
        ...
        ///     Updated with the method's <see cref="MethodBody" /> if this
        ///     method returns <c>true</c>
        /// </param>
        /// <returns>
        ///     <c>true</c> if the method body was decrypted, <c>false</c> if the method isn't
        ///     encrypted and the default <see cref="MethodDef" /> body reader code should be used.
        /// </returns>
