namespace dnlib.DotNet
{
    ...
    public abstract class PublicKeyBase
    {
        ...
        ///     Key data as a hex string or the string <c>"null"</c>
        ///     to set key data to <c>null</c>
        /// </param>
        ...
        /// </summary>
        public abstract PublicKeyToken Token
        {
            get;
        }
        ...
        /// <returns>
        ///     A new <see cref="PublicKey" /> instance or <c>null</c> if <paramref name="data" />
        ///     was <c>null</c>
        /// </returns>
        ...
        /// <returns>
        ///     A new <see cref="PublicKeyToken" /> instance or <c>null</c> if <paramref name="data" />
        ///     was <c>null</c>
        /// </returns>
