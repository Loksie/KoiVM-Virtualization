    ...
    public static partial class Extensions
    {
        ...
        public static CorLibTypeSig GetCorLibTypeSig(this ICorLibTypes self, ITypeDefOrRef type)
        {
            ...
            if((td = type as TypeDef) != null &&
               ...
               (corLibType = self.GetCorLibTypeSig(td.Namespace, td.Name, td.DefinitionAssembly)) != null) return corLibType;

            TypeRef tr;
            if((tr = type as TypeRef) != null &&
               !(tr.ResolutionScope is TypeRef) &&
               (corLibType = self.GetCorLibTypeSig(tr.Namespace, tr.Name, tr.DefinitionAssembly)) != null) return corLibType;
