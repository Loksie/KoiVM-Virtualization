...
namespace dnlib.DotNet
{
    ...
    public interface ISignatureReaderHelper
    {
        ...
        /// <returns>
        ///     A <see cref="ITypeDefOrRef" /> or <c>null</c> if <paramref name="codedToken" />
        ///     is invalid
        /// </returns>
        ...
        /// <param name="address">
        ///     Address of <see cref="Type" />. This is also known as the
        ///     method table and has the same value as <see cref="RuntimeTypeHandle.Value" />
        /// </param>
    ...
    public struct SignatureReader : IDisposable
    {
        ...
        /// <returns>
        ///     A new <see cref="CallingConventionSig" /> instance or <c>null</c> if
        ///     <paramref name="signature" /> is invalid.
        /// </returns>
