namespace dnlib.DotNet
{
    ...
    public sealed class CorLibTypes : ICorLibTypes
    {
        ...
        /// </summary>
        /// <param name="module">The owner module</param>
        /// <param name="corLibAssemblyRef">
        ///     Corlib assembly reference or <c>null</c> if a default
        ///     assembly reference should be created
        /// </param>
        public CorLibTypes(ModuleDef module, AssemblyRef corLibAssemblyRef)
        {
            this.module = module;
            AssemblyRef = corLibAssemblyRef ?? CreateCorLibAssemblyRef();
            Initialize();
        }
        ...
        {
            var isCorLib = module.Assembly.IsCorLib();
