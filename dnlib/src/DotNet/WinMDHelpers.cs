...
namespace dnlib.DotNet
{
    ...
    internal static class WinMDHelpers
    {
        ...
        private static readonly byte[] contractPublicKeyToken = {0xB0, 0x3F, 0x5F, 0x7F, 0x11, 0xD5, 0x0A, 0x3A};
        private static readonly byte[] neutralPublicKey = {0xb7, 0x7a, 0x5c, 0x56, 0x19, 0x34, 0xe0, 0x89};
        ...
        public static TypeSig ToCLR(ModuleDef module, TypeSig ts)
        {
            ...
            return isClrValueType ? (TypeSig) new ValueTypeSig(newTr) : new ClassSig(newTr);
        }
        ...
        public static MemberRef ToCLR(ModuleDef module, MemberRef mr)
        {
            ...
            else if((ts = cl as TypeSpec) != null)
            {
                ...
                newCl = new TypeSpecUser(new GenericInstSig(isClrValueType ? (ClassOrValueTypeSig) new ValueTypeSig(newTr) : new ClassSig(newTr), gis.GenericArguments));
            }
            else
            {
                return null;
