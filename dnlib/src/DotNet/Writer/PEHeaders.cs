...
namespace dnlib.DotNet.Writer
{
    ...
    public sealed class PEHeadersOptions
    {
        ...
        /// </summary>
        public const DllCharacteristics DefaultDllCharacteristics = PE.DllCharacteristics.TerminalServerAware | PE.DllCharacteristics.NoSeh | PE.DllCharacteristics.NxCompat | PE.DllCharacteristics.DynamicBase;

        /// <summary>
        ///     Default subsystem value
        /// </summary>
        public const Subsystem DEFAULT_SUBSYSTEM = PE.Subsystem.WindowsGui;
    ...
    public sealed class PEHeaders : IChunk
    {
        ...
        public void WriteTo(BinaryWriter writer)
        {
            ...
            var ep = StartupStub == null ? 0 : (uint) StartupStub.EntryPointRVA;
            if(Use32BitOptionalHeader())
            {
            ...
            // Sections
            var rva = Utils.AlignUp(sectionSizes.SizeOfHeaders, SectionAlignment);
        ...
        public void WriteCheckSum(BinaryWriter writer, long length)
        {
            ...
            var checkSum = new BinaryReader(writer.BaseStream).CalculatePECheckSum(length, checkSumOffset);
