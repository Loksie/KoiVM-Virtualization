...
namespace dnlib.DotNet.Writer
{
    ...
    public static class MDTableWriter
    {
        ...
        public static void Write(this BinaryWriter writer, IMDTable table)
        {
            ...
            {
                case Table.Module:
                    writer.Write((MDTable<RawModuleRow>) table);
                    break;
                case Table.TypeRef:
                    writer.Write((MDTable<RawTypeRefRow>) table);
                    break;
                case Table.TypeDef:
                    writer.Write((MDTable<RawTypeDefRow>) table);
                    break;
                case Table.FieldPtr:
                    writer.Write((MDTable<RawFieldPtrRow>) table);
                    break;
                case Table.Field:
                    writer.Write((MDTable<RawFieldRow>) table);
                    break;
                case Table.MethodPtr:
                    writer.Write((MDTable<RawMethodPtrRow>) table);
                    break;
                case Table.Method:
                    writer.Write((MDTable<RawMethodRow>) table);
                    break;
                case Table.ParamPtr:
                    writer.Write((MDTable<RawParamPtrRow>) table);
                    break;
                case Table.Param:
                    writer.Write((MDTable<RawParamRow>) table);
                    break;
                case Table.InterfaceImpl:
                    writer.Write((MDTable<RawInterfaceImplRow>) table);
                    break;
                case Table.MemberRef:
                    writer.Write((MDTable<RawMemberRefRow>) table);
                    break;
                case Table.Constant:
                    writer.Write((MDTable<RawConstantRow>) table);
                    break;
                case Table.CustomAttribute:
                    writer.Write((MDTable<RawCustomAttributeRow>) table);
                    break;
                case Table.FieldMarshal:
                    writer.Write((MDTable<RawFieldMarshalRow>) table);
                    break;
                case Table.DeclSecurity:
                    writer.Write((MDTable<RawDeclSecurityRow>) table);
                    break;
                case Table.ClassLayout:
                    writer.Write((MDTable<RawClassLayoutRow>) table);
                    break;
                case Table.FieldLayout:
                    writer.Write((MDTable<RawFieldLayoutRow>) table);
                    break;
                case Table.StandAloneSig:
                    writer.Write((MDTable<RawStandAloneSigRow>) table);
                    break;
                case Table.EventMap:
                    writer.Write((MDTable<RawEventMapRow>) table);
                    break;
                case Table.EventPtr:
                    writer.Write((MDTable<RawEventPtrRow>) table);
                    break;
                case Table.Event:
                    writer.Write((MDTable<RawEventRow>) table);
                    break;
                case Table.PropertyMap:
                    writer.Write((MDTable<RawPropertyMapRow>) table);
                    break;
                case Table.PropertyPtr:
                    writer.Write((MDTable<RawPropertyPtrRow>) table);
                    break;
                case Table.Property:
                    writer.Write((MDTable<RawPropertyRow>) table);
                    break;
                case Table.MethodSemantics:
                    writer.Write((MDTable<RawMethodSemanticsRow>) table);
                    break;
                case Table.MethodImpl:
                    writer.Write((MDTable<RawMethodImplRow>) table);
                    break;
                case Table.ModuleRef:
                    writer.Write((MDTable<RawModuleRefRow>) table);
                    break;
                case Table.TypeSpec:
                    writer.Write((MDTable<RawTypeSpecRow>) table);
                    break;
                case Table.ImplMap:
                    writer.Write((MDTable<RawImplMapRow>) table);
                    break;
                case Table.FieldRVA:
                    writer.Write((MDTable<RawFieldRVARow>) table);
                    break;
                case Table.ENCLog:
                    writer.Write((MDTable<RawENCLogRow>) table);
                    break;
                case Table.ENCMap:
                    writer.Write((MDTable<RawENCMapRow>) table);
                    break;
                case Table.Assembly:
                    writer.Write((MDTable<RawAssemblyRow>) table);
                    break;
                case Table.AssemblyProcessor:
                    writer.Write((MDTable<RawAssemblyProcessorRow>) table);
                    break;
                case Table.AssemblyOS:
                    writer.Write((MDTable<RawAssemblyOSRow>) table);
                    break;
                case Table.AssemblyRef:
                    writer.Write((MDTable<RawAssemblyRefRow>) table);
                    break;
                case Table.AssemblyRefProcessor:
                    writer.Write((MDTable<RawAssemblyRefProcessorRow>) table);
                    break;
                case Table.AssemblyRefOS:
                    writer.Write((MDTable<RawAssemblyRefOSRow>) table);
                    break;
                case Table.File:
                    writer.Write((MDTable<RawFileRow>) table);
                    break;
                case Table.ExportedType:
                    writer.Write((MDTable<RawExportedTypeRow>) table);
                    break;
                case Table.ManifestResource:
                    writer.Write((MDTable<RawManifestResourceRow>) table);
                    break;
                case Table.NestedClass:
                    writer.Write((MDTable<RawNestedClassRow>) table);
                    break;
                case Table.GenericParam:
                    writer.Write((MDTable<RawGenericParamRow>) table);
                    break;
                case Table.MethodSpec:
                    writer.Write((MDTable<RawMethodSpecRow>) table);
                    break;
                case Table.GenericParamConstraint:
                    writer.Write((MDTable<RawGenericParamConstraintRow>) table);
                    break;
        ...
        {
            var cols = table.TableInfo.Columns;
            var useKindColumn = cols.Count >= 5;
            foreach(var row in table)
            {
