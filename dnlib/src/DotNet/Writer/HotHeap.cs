...
namespace dnlib.DotNet.Writer
{
    ...
    public abstract class HotHeap : HeapBase
    {
        ...
        /// </summary>
        public abstract HotHeapVersion HotHeapVersion
        {
            get;
        }
        ...
        protected override void WriteToImpl(BinaryWriter writer)
        {
            ...
            WriteAlign(writer, ref offs);
            var poolDBOffs = writer.BaseStream.Position;
            for(var i = 0; i < hotPools.Count; i++)
            {
            ...
            var hotMDDirOffs = writer.BaseStream.Position;
            // any alignment
            writer.Write(offs - HOT_HEAP_DIR_SIZE);
            // CLR 2.0: low 2 bits are ignored
            // CLR 4.0: any alignment, all bits are used
        ...
        {
            var align = Utils.AlignUp(offs, HH_ALIGNMENT) - offs;
            offs += align;
