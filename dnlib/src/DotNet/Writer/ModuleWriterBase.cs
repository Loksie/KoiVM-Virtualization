...
namespace dnlib.DotNet.Writer
{
    ...
    public class ModuleWriterOptionsBase
    {
        ...
        ///     or
        ///     <see
        ///         cref="InitializeEnhancedStrongNameSigning(ModuleDef,StrongNameKey,StrongNamePublicKey,StrongNameKey,StrongNamePublicKey)" />
        ...
        /// </summary>
        public CreatePdbSymbolWriterDelegate CreatePdbSymbolWriter
        {
            get;
            set;
        }
    ...
    public abstract class ModuleWriterBase : IMetaDataListener, ILogger
    {
        ...
        /// </summary>
        public abstract ModuleWriterOptionsBase TheOptions
        {
            get;
        }
        ...
        /// </summary>
        public abstract List<PESection> Sections
        {
            get;
        }
        ...
        /// </summary>
        public abstract PESection TextSection
        {
            get;
        }
        ...
        /// </summary>
        public abstract PESection RsrcSection
        {
            get;
        }
        ...
        /// </summary>
        public abstract ModuleDef Module
        {
            get;
        }
        ...
        protected void CreateStrongNameSignature()
        {
            ...
            {
                var len = Module.Assembly.PublicKey.Data.Length - 0x20;
