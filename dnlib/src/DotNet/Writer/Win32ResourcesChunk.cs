...
namespace dnlib.DotNet.Writer
{
    ...
    public sealed class Win32ResourcesChunk : IChunk
    {
        ...
        public void WriteTo(BinaryWriter writer)
        {
            ...
            foreach(var dir in dirList)
            {
                var padding = Utils.AlignUp(offset, RESOURCE_DIR_ALIGNMENT) - offset;
            ...
            {
                var padding = Utils.AlignUp(offset, RESOURCE_DATA_HEADER_ALIGNMENT) - offset;
                writer.WriteZeros((int) padding);
                offset += padding;
            ...
            foreach(var s in stringsList)
            {
                var padding = Utils.AlignUp(offset, RESOURCE_STRING_ALIGNMENT) - offset;
                writer.WriteZeros((int) padding);
                offset += padding;
            ...
            foreach(var data in dataList)
            {
                var padding = Utils.AlignUp(offset, RESOURCE_DATA_ALIGNMENT) - offset;
                writer.WriteZeros((int) padding);
                offset += padding;
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="dirEntry" /> is valid and
        ///     <paramref name="fileOffset" /> and <paramref name="rva" /> have been updated. <c>false</c>
        ///     if <paramref name="dirEntry" /> is not part of the Win32 resources.
        /// </returns>
        ...
        /// <param name="rva">Updated with the RVA</param>
        /// <returns>
        ///     <c>true</c> if <paramref name="dir" /> is valid and
        ///     <paramref name="fileOffset" /> and <paramref name="rva" /> have been updated. <c>false</c>
        ///     if <paramref name="dir" /> is not part of the Win32 resources.
        /// </returns>
        ...
        /// <param name="rva">Updated with the RVA</param>
        /// <returns>
        ///     <c>true</c> if <paramref name="dataHeader" /> is valid and
        ///     <paramref name="fileOffset" /> and <paramref name="rva" /> have been updated. <c>false</c>
        ///     if <paramref name="dataHeader" /> is not part of the Win32 resources.
        /// </returns>
        ...
        /// <param name="rva">Updated with the RVA</param>
        /// <returns>
        ///     <c>true</c> if <paramref name="data" /> is valid and
        ///     <paramref name="fileOffset" /> and <paramref name="rva" /> have been updated. <c>false</c>
        ///     if <paramref name="data" /> is not part of the Win32 resources.
        /// </returns>
        ...
        /// <param name="rva">Updated with the RVA</param>
        /// <returns>
        ///     <c>true</c> if <paramref name="name" /> is valid and
        ///     <paramref name="fileOffset" /> and <paramref name="rva" /> have been updated. <c>false</c>
        ///     if <paramref name="name" /> is not part of the Win32 resources.
        /// </returns>
