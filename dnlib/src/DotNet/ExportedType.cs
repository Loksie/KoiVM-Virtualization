...
namespace dnlib.DotNet
{
    ...
    public abstract class ExportedType : IHasCustomAttribute, IImplementation, IType
    {
        ...
        public bool MovedToAnotherAssembly
        {
            ...
            {
                var et = this;
                for(var i = 0; i < MAX_LOOP_ITERS; i++)
                {
        ...
        public TypeRef ToTypeRef()
        {
            ...
            for(var i = 0; i < MAX_LOOP_ITERS && impl != null; i++)
            {
    ...
    internal sealed class ExportedTypeMD : ExportedType, IMDTokenProviderMD
    {
        ...
        public ExportedTypeMD(ModuleDefMD readerModule, uint rid)
        {
            ...
            module = readerModule;
            uint name, @namespace;
            implementationRid = readerModule.TablesStream.ReadExportedTypeRow(OrigRid, out attributes, out typeDefId, out name, out @namespace);
