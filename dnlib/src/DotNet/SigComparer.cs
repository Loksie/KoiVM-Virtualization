...
namespace dnlib.DotNet
{
    ...
    public struct SigComparer
    {
        ...
        private bool SubstituteGenericParameters => (options & SigComparerOptions.SubstituteGenericParameters) != 0;
        ...
        public bool Equals(TypeRef a, ExportedType b)
        {
            ...
            var result = Equals_TypeNames(a.Name, b.TypeName) &&
        ...
        public bool Equals(TypeRef a, TypeRef b)
        {
            ...
            var result = Equals_TypeNames(a.Name, b.Name) &&
        ...
        public bool Equals(ExportedType a, ExportedType b)
        {
            ...
            var result = Equals_TypeNames(a.TypeName, b.TypeName) &&
        ...
        public bool Equals(TypeSpec a, TypeSpec b)
        {
            ...
            var result = Equals(a.TypeSig, b.TypeSig);
        ...
        private bool Equals(ModuleDef a, ModuleDef b)
        {
            ...
            var result = Equals(a, (IModule) b) && Equals(a.Assembly, b.Assembly);
        ...
        private bool Equals(IAssembly a, IAssembly b)
        {
            ...
            var result = UTF8String.CaseInsensitiveEquals(a.Name, b.Name) &&
        ...
        public bool Equals(TypeSig a, TypeSig b)
        {
            ...
            if(a.ElementType != b.ElementType) result = false;
            else
        ...
        public bool Equals(MethodBaseSig a, MethodBaseSig b)
        {
            ...
            var result = a.GetCallingConvention() == b.GetCallingConvention() &&
        ...
        public bool Equals(FieldSig a, FieldSig b)
        {
            ...
            var result = a.GetCallingConvention() == b.GetCallingConvention() && Equals(a.Type, b.Type);
        ...
        public bool Equals(LocalSig a, LocalSig b)
        {
            ...
            var result = a.GetCallingConvention() == b.GetCallingConvention() && Equals(a.Locals, b.Locals);
        ...
        public bool Equals(GenericInstMethodSig a, GenericInstMethodSig b)
        {
            ...
            var result = a.GetCallingConvention() == b.GetCallingConvention() && Equals(a.GenericArguments, b.GenericArguments);
        ...
        public int GetHashCode(MethodDef a)
        {
            ...
            var hash = GetHashCode_MethodFieldName(a.Name) +
        ...
        public bool Equals(MemberRef a, MemberRef b)
        {
            ...
            var result = Equals_MethodFieldNames(a.Name, b.Name) &&
                         Equals(a.Signature, b.Signature) &&
        ...
        public bool Equals(MethodSpec a, MethodSpec b)
        {
            ...
            var result = Equals(a.Method, b.Method) && Equals(a.Instantiation, b.Instantiation);
        ...
        private int GetHashCode(IMemberRefParent a)
        {
            ...
            else if((ma = a as MethodDef) != null) hash = GetHashCode(ma.DeclaringType);
            else
                hash = 0;
        ...
        public bool Equals(FieldDef a, MemberRef b)
        {
            ...
            var result = (PrivateScopeFieldIsComparable || !a.IsPrivateScope) &&
                         Equals_MethodFieldNames(a.Name, b.Name) &&
                         Equals(a.Signature, b.Signature) &&
                         (!CompareMethodFieldDeclaringType || Equals(a.DeclaringType, b.Class));
        ...
        public bool Equals(PropertyDef a, PropertyDef b)
        {
            ...
            var result = Equals_PropertyNames(a.Name, b.Name) &&
        ...
        public int GetHashCode(PropertyDef a)
        {
            ...
            var hash = GetHashCode_PropertyName(a.Name) +
        ...
        public bool Equals(EventDef a, EventDef b)
        {
            ...
            var result = Equals_EventNames(a.Name, b.Name) &&
        ...
        public int GetHashCode(EventDef a)
        {
            ...
            var hash = GetHashCode_EventName(a.Name) +
        ...
        private bool EqualsGlobal(TypeDef a, ModuleRef b)
        {
            ...
            var result = a.IsGlobalModuleType &&
                         Equals(a.Module, b) &&
        ...
        ///     <c>true</c> if we should treat <paramref name="b" />
                ...
                case ElementType.Array:
                    ...
                    else
                    {
                        ...
                        result = ara.Rank == b.GetArrayRank() &&
                                 (IsFnPtrElementType(b) ? (a = a.Next.RemoveModifiers()) != null && a.ElementType == ElementType.FnPtr : Equals(a.Next, b.GetElementType()));
                    }
                    break;
        ...
        /// <param name="a">The type</param>
        /// <param name="treatAsGenericInst">
        ///     <c>true</c> if we should treat <paramref name="a" />
        ///     as a generic instance type
        /// </param>
        /// <returns>The hash code</returns>
        ...
        private static int GetHashCode(int numGenericParams, int etypeHashCode)
        {
            ...
            //************************************************************************
            uint hash = 0;
            for(var i = 0; i < numGenericParams; i++)
            {
        ...
        private bool Equals(ModuleDef a, Module b)
        {
            ...
            var result = Equals((IModule) a, b) && Equals(a.Assembly, b.Assembly);
        ...
        private bool Equals(IAssembly a, Assembly b)
        {
            ...
            var result = UTF8String.ToSystemStringOrEmpty(a.Name).Equals(bAsmName.Name, StringComparison.OrdinalIgnoreCase) &&
        ...
        public bool Equals(MethodSig a, MethodBase b)
        {
            ...
            var result = Equals(a.GetCallingConvention(), b) &&
        ...
        public bool Equals(MethodSpec a, MethodBase b)
        {
            ...
            var result = b.IsGenericMethod && !b.IsGenericMethodDefinition;
        ...
        private bool Equals(TypeSig a, ParameterInfo b, Type declaringType)
        {
            ...
            TypeSig a2;
            var result = ModifiersEquals(a, b.GetRequiredCustomModifiers(), b.GetOptionalCustomModifiers(), out a2) &&
        ...
        private bool Equals(FieldSig a, FieldInfo b)
        {
            ...
            TypeSig a2;
            var result = ModifiersEquals(a.Type, b.GetRequiredCustomModifiers(), b.GetOptionalCustomModifiers(), out a2) &&
        ...
        private bool Equals(PropertySig a, PropertyInfo b)
        {
            ...
            TypeSig a2;
            var result = ModifiersEquals(a.RetType, b.GetRequiredCustomModifiers(), b.GetOptionalCustomModifiers(), out a2) &&
