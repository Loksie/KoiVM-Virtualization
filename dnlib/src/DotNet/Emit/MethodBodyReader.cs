...
namespace dnlib.DotNet.Emit
{
    ...
    public sealed class MethodBodyReader : MethodBodyReaderBase
    {
        ...
        private readonly IBinaryReader exceptionsReader;
        ...
        /// <param name="ehReader">
        ///     Exception handler reader or <c>null</c> if exceptions aren't
        ///     present or if <paramref name="codeReader" /> contains the exception handlers
        /// </param>
        /// <param name="parameters">Method parameters</param>
        ...
        ///     Exceptions or <c>null</c> if all exception handlers are in
        ///     <paramref name="code" />
        /// </param>
        /// <param name="parameters">Method parameters</param>
        ...
        public CilBody CreateCilBody()
        {
            ...
            var initLocals = flags == 2 || (flags & 0x10) != 0;
