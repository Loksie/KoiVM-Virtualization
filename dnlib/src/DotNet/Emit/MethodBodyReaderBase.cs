...
namespace dnlib.DotNet.Emit
{
    ...
    public abstract class MethodBodyReaderBase
    {
        ...
        protected void ReadInstructions(int numInstrs)
        {
            ...
            currentOffset = 0;
            for(var i = 0; i < numInstrs && reader.Position < codeEndOffs; i++)
            ...
            foreach(var instr in instructions)
                switch(instr.OpCode.OperandType)
                {
                    ...
                    case OperandType.InlineSwitch:
                        ...
                        for(var i = 0; i < uintTargets.Count; i++)
        ...
        protected virtual IList<uint> ReadInlineSwitch(Instruction instr)
        {
            ...
            var offsetAfterInstr = instr.Offset + instr.OpCode.Size + 4L + (long) num * 4;
            ...
            var offset = (uint) offsetAfterInstr;
        ...
        /// </summary>
        /// <param name="instr">
        ///     The instruction or <c>null</c> if the offset is the first offset
