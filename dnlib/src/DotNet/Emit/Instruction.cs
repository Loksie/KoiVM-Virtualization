...
namespace dnlib.DotNet.Emit
{
    ...
    public sealed class Instruction
    {
        ...
        /// </summary>
        /// <param name="stack">Current stack size</param>
        /// <param name="methodHasReturnValue">
        ///     <c>true</c> if the method has a return value,
        ///     <c>false</c> otherwise
        /// </param>
        ...
        /// <param name="pops">
        ///     Updated with number of stack pops or <c>-1</c> if the stack should
        ///     be cleared.
        /// </param>
        ...
        private void CalculateStackUsageCall(OpCode opCode, out int pushes, out int pops)
        {
            ...
            if(sig == null)
                return;
            var implicitThis = sig.ImplicitThis;
        ...
        ///     <see cref="OpCode" /> isn't one of the
        ///     <c>ldc.i4</c> opcodes
        /// </exception>
        ...
        /// <returns>
        ///     The local or <c>null</c> if it's not a <c>ldloc</c> or <c>stloc</c>
