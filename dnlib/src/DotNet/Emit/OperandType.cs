...
namespace dnlib.DotNet.Emit
{
    ...
    public enum OperandType : byte
    {
        ...
        /// <summary>
        ///     4-byte method token (<see cref="Table.Method" />, <see cref="Table.MemberRef" />
        ///     or <see cref="Table.MethodSpec" />)
        /// </summary>
        InlineMethod,
        ...
        /// <summary>
        ///     4-byte token (<see cref="Table.Field" />, <see cref="Table.MemberRef" />,
        ///     <see cref="Table.Method" />, <see cref="Table.MethodSpec" />, <see cref="Table.TypeDef" />,
        ///     <see cref="Table.TypeRef" /> or <see cref="Table.TypeSpec" />)
        /// </summary>
        InlineTok,

        /// <summary>
        ///     4-byte type token (<see cref="Table.TypeDef" />, <see cref="Table.TypeRef" /> or
        ///     <see cref="Table.TypeSpec" />)
        /// </summary>
        InlineType,
