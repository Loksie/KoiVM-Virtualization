...
namespace dnlib.DotNet
{
    ...
    public interface IAssemblyResolver
    {
        ...
        /// <returns>
        ///     An <see cref="AssemblyDef" /> instance owned by the assembly resolver or
        ///     <c>null</c> if the assembly couldn't be found.
        /// </returns>
    ...
    public static partial class Extensions
    {
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="module" />'s assembly is cached, <c>false</c>
        ///     if it's not cached because some other assembly with the exact same full name has
        ///     already been cached or if <paramref name="module" /> or its assembly is <c>null</c>.
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if its assembly was removed, <c>false</c> if it wasn't removed
