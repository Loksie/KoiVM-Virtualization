...
namespace dnlib.DotNet
{
    ...
    public struct CustomAttributeReader : IDisposable
    {
        ...
        /// <param name="gpContext">Generic parameter context</param>
        /// <returns>
        ///     A list of <see cref="CANamedArgument" />s or <c>null</c> if some error
        ///     occurred.
        /// </returns>
        ...
        private CustomAttribute Read(ICustomAttributeType ctor)
        {
            ...
            var isEmpty = methodSig.Params.Count == 0 && reader.Position == reader.Length;
            ...
            var numNamedArgs = reader.Position == reader.Length ? 0 : reader.ReadUInt16();
