...
namespace dnlib.DotNet.Resources
{
    ...
    {
        private readonly Dictionary<UserResourceData, UserResourceType> dataToNewType = new Dictionary<UserResourceData, UserResourceType>();
        private readonly ModuleDef module;
        private readonly ResourceElementSet resources;
        private readonly ResourceDataCreator typeCreator;
        ...
        private void Write()
        {
            ...
            var extraBytes = 8 - ((int) writer.BaseStream.Position & 7);
            if(extraBytes != 8)
