...
namespace dnlib.DotNet.Resources
{
    ...
    public struct ResourceReader
    {
        ...
        /// <param name="module">Owner module</param>
        /// <param name="reader">Data of resource</param>
        /// <param name="createResourceDataDelegate">
        ///     Call back that gets called to create a <see cref="IResourceData" /> instance.
        ///     Can be null.
        /// </param>
        /// <returns></returns>
        ...
        private ResourceElementSet Read()
        {
            ...
            var numUserTypes = reader.ReadInt32();
            if(numUserTypes < 0)
            ...
            var nameBaseOffset = reader.Position;
            ...
            for(var i = 0; i < numResources; i++)
            {
                ...
                var offset = dataBaseOffset + reader.ReadInt32();
            ...
            for(var i = 0; i < infos.Count; i++)
            {
                ...
                var nextDataOffset = i == infos.Count - 1 ? end : infos[i + 1].offset;
                var size = (int) (nextDataOffset - info.offset);
        ...
        private IResourceData ReadResourceData(List<UserResourceType> userTypes, int size)
        {
            ...
            switch((ResourceTypeCode) code)
            {
                ...
                default:
                    var userTypeIndex = (int) (code - (uint) ResourceTypeCode.UserTypes);
