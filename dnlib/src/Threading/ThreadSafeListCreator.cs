...
namespace dnlib.Threading
{
    ...
    public static class ThreadSafeListCreator
    {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(T value)
        {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(T value1, T value2)
        {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(T value1, T value2, T value3)
        {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(params T[] args)
        {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(int capacity)
        {
        ...
        /// <returns>A new thread-safe list instance</returns>
        public static IList<T> Create<T>(IEnumerable<T> collection)
        {
        ...
        public static IList<T> MakeThreadSafe<T>(IList<T> list)
        {
#if THREAD_SAFE
			if (list == null)
				return null;
