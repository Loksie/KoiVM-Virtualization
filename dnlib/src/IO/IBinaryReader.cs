...
namespace dnlib.IO
{
    ...
    public interface IBinaryReader : IDisposable
    {
        ...
        /// <returns>
        ///     All available bytes. This can be less than <paramref name="size" /> bytes
        ///     if there's not enough bytes left.
        /// </returns>
        ...
        /// <returns>
        ///     Number of bytes read, and can be less than <paramref name="length" /> if
        ///     there's no more bytes to read.
        /// </returns>
        ...
        /// <returns>
        ///     All the bytes (not including <paramref name="b" />) or <c>null</c> if
        ///     <paramref name="b" /> wasn't found.
        /// </returns>
    ...
    public static partial class IOExtensions
    {
        ...
        ///     <c>true</c> if the created <see cref="Stream" /> owns
