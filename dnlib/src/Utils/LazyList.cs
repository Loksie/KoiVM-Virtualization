...
namespace dnlib.Utils
{
    ...
    public interface IListListener<TListValue>
    {
        ...
        /// </summary>
        /// <remarks>
        ///     If you must access this list, you can only call <c>_NoLock()</c> methods
    ...
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly object context;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly MFunc<object, uint, TValue> readOriginalValue;

        [DebuggerBrowsable(DebuggerBrowsableState.RootHidden)] private readonly List<Element> list;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private int id;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly IListListener<TValue> listener;
