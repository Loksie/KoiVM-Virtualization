...
namespace dnlib.Utils
{
    ...
    public interface ILazyList<TValue> : ThreadSafe.IList<TValue>
    {
        ...
        /// </summary>
        /// <param name="clearList">
        ///     <c>true</c> if the list should be cleared before returning,
        ///     <c>false</c> if the list should not cleared.
        /// </param>
        ThreadSafe.List<TValue> GetInitializedElements(bool clearList);
    }
    ...
    public static partial class Extensions
    {
        ...
        public static void DisposeAll<TValue>(this ILazyList<TValue> list) where TValue : IDisposable
        {
            ...
            {
                for(var i = 0; i < list.Count_NoLock(); i++)
