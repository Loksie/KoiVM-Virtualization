...
namespace dnlib.Utils
{
    ...
    {
        [DebuggerBrowsable(DebuggerBrowsableState.RootHidden)] private readonly T[] elements;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly uint length;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly MFunc<uint, T> readElementByRID;

        /// <summary>
        ///     Constructor
        /// </summary>
        /// <param name="length">Length of the list</param>
        /// <param name="readElementByRID">
    ...
    internal sealed class SimpleLazyList2<T> where T : class, IContainsGenericParameter
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly MFunc<uint, GenericParamContext, T> readElementByRID;
        ...
        /// <param name="readElementByRID">
        ///     Delegate instance that lazily reads an element. It might
        ///     be called more than once for each <c>rid</c>. It must never return <c>null</c>.
        /// </param>
