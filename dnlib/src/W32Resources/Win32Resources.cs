...
namespace dnlib.W32Resources
{
    ...
    public abstract class Win32Resources : IDisposable
    {
        ...
        /// </summary>
        public abstract ResourceDirectory Root
        {
            get;
            set;
        }
    ...
    public sealed class Win32ResourcesPE : Win32Resources
    {
        ...
        ///     Data reader (it's used after converting an <see cref="RVA" />
        ///     to a <see cref="FileOffset" />). This instance owns the reader.
        /// </param>
        /// <param name="rsrcReader">
        ...
        ///     directory in the optional header. This instance owns the reader.
        /// </param>
