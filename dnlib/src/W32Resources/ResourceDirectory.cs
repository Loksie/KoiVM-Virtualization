...
namespace dnlib.W32Resources
{
    ...
    public sealed class ResourceDirectoryPE : ResourceDirectory
    {
        ...
        /// </summary>
        private ThreadSafe.List<EntryInfo> dataInfos;

        /// <summary>
        ///     Directory depth. When creating more <see cref="ResourceDirectoryPE" />'s,
        ...
        /// </summary>
        private ThreadSafe.List<EntryInfo> dirInfos;
