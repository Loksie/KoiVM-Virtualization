...
namespace Confuser.Renamer
{
    public class VTableSignature
    {
        ...
        public static VTableSignature FromMethod(IMethod method)
        {
            ...
            if(declType is GenericInstSig) sig = GenericArgumentResolver.Resolve(sig, ((GenericInstSig) declType).GenericArguments);
    ...
    public class VTable
    {
        ...
        private class VTableConstruction
        {
            ...
            public readonly Dictionary<TypeSig, Dictionary<VTableSignature, VTableSlot>> InterfaceSlots = new Dictionary<TypeSig, Dictionary<VTableSignature, VTableSlot>>(TypeSigComparer.Instance);

            // All visible virtual method slots (i.e. excluded those being shadowed)
            public readonly Dictionary<VTableSignature, VTableSlot> SlotsMap = new Dictionary<VTableSignature, VTableSlot>();
    ...
    public class VTableStorage
    {
        ...
        private readonly Dictionary<TypeDef, VTable> storage = new Dictionary<TypeDef, VTable>();
