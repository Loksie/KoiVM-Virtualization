        ...
        public void Analyze(ConfuserContext context, INameService service, ProtectionParameters parameters, IDnlibDef def)
        {
            ...
            if(def is TypeDef)
            {
                ...
                foreach(var slot in ifaceVTbl)
                {
                    ...
                    if(!baseUnderCtrl && ifaceUnderCtrl || !service.CanRename(slot.MethodDef)) service.SetCanRename(slot.Overrides.MethodDef, false);
                    else if(baseUnderCtrl && !ifaceUnderCtrl || !service.CanRename(slot.Overrides.MethodDef)) service.SetCanRename(slot.MethodDef, false);
                }
            }
