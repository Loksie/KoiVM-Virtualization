...
namespace Confuser.Renamer.Analyzers
{
    internal class WPFAnalyzer : IRenamer
    {
        ...
        public void Analyze(ConfuserContext context, INameService service, ProtectionParameters parameters, IDnlibDef def)
        {
            ...
            if(module != null) AnalyzeResources(context, service, module);
        }
            ...
            foreach(var doc in res.Values)
            {
                ...
                if(bamlRefs.TryGetValue(doc.DocumentName, out references))
                {
                    ...
                    * */
                    ...
                    for(var i = 0; i <= completePath.Length - 2; i++) newShinyName += completePath[i].ToLowerInvariant() + "/";
                    if(newName.EndsWith(".BAML"))
            ...
            for(var i = 0; i < method.Body.Instructions.Count; i++)
            {
                ...
                if(instr.OpCode.Code == Code.Call || instr.OpCode.Code == Code.Callvirt)
                {
                    ...
                    if(regMethod.DeclaringType.FullName == "System.Windows.DependencyProperty" &&
                       regMethod.Name.String.StartsWith("Register")) dpRegInstrs.Add(Tuple.Create(regMethod.Name.String.StartsWith("RegisterAttached"), instr));
                    else if(regMethod.DeclaringType.FullName == "System.Windows.EventManager" &&
                            regMethod.Name.String == "RegisterRoutedEvent") routedEvtRegInstrs.Add(instr);
                }
