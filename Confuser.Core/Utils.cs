...
namespace Confuser.Core
{
    ...
    public static class Utils
    {
        ...
        private static readonly List<string> duplicates = new List<string>();
        ...
        {
            const string chars = "A安的B不C吧的不他DE八FG的不二H爸IJ百的KL二不M北不他的NOP的爸Q二RS他T百的不UV不北WX百他YZ二北他01爸23北4他56百7二8北百9";
            return new string(Enumerable.Repeat(chars, length)
                .Select(s => s[random.Next(s.Length)]).ToArray());
        }

        public static string repeatingChar()
        {
            //int repetitions = 0;
            ...
            //else
            //   {                           
            //   return RandomString(r.Next(1, 500));
            //   }
            ...
            if(retries < 20)
            {
                ...
                if(retries > 18)
                    return RandomString(r.Next(1, 25));
                goto redo;
            }
