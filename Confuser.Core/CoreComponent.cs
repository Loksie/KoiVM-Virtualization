...
namespace Confuser.Core
{
    ...
    public class CoreComponent : ConfuserComponent
    {
        ...
        /// <inheritdoc />
        public override string Name => "Confuser Core";

        /// <inheritdoc />
        public override string Description => "Initialization of Confuser core services.";

        /// <inheritdoc />
        public override string Id => "Confuser.Core";

        /// <inheritdoc />
        public override string FullId => "Confuser.Core";
