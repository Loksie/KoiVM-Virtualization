...
namespace Confuser.Protections.AntiTamper
{
    internal class NormalMode : IModeHandler
    {
        ...
        private void OnWriterEvent(object sender, ModuleWriterListenerEventArgs e)
        {
            ...
            if(e.WriterEvent == ModuleWriterEvent.MDEndCreateTables) CreateSections(writer);
            else if(e.WriterEvent == ModuleWriterEvent.BeginStrongNameSign) EncryptSection(writer);
        }
